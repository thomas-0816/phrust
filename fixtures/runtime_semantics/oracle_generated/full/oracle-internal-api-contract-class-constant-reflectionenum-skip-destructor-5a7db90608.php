<?php
// oracle-probe: id=oracle-internal-api-contract-class-constant-reflectionenum-skip-destructor-5a7db90608 area=internal_api_contract kind=class_constant symbol=ReflectionEnum::SKIP_DESTRUCTOR source=reference-php expect=pass
// runtime-semantics: category=oracle_generated expect=pass php_ref_required=0 php_ref_optional_reason=missing_reference_extension oracle_probe_id=oracle-internal-api-contract-class-constant-reflectionenum-skip-destructor-5a7db90608 failure_category=internal_api_contract requires_ref_extension=reflection
