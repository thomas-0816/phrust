import { createFuture, createReadableStream, createReadableStreamPollState, createWritableStream, futureDispose, futureTakeValue, pollStateReady, verifyPollsDroppedForDrop, } from "./worker-thread.js";
import process from "node:process";
// TODO: tcp_wrap is no longer exposed in newer versions of Node.js
const { TCP, constants: TCPConstants } = process.binding("tcp_wrap");
import { convertSocketError, convertSocketErrorCode, ipSocketAddress, isIPv4MappedAddress, isMulticastIpAddress, isUnicastIpAddress, isWildcardAddress, noLookup, serializeIpAddress, SOCKET_STATE_BIND, SOCKET_STATE_BOUND, SOCKET_STATE_CLOSED, SOCKET_STATE_CONNECT, SOCKET_STATE_CONNECTION, SOCKET_STATE_INIT, SOCKET_STATE_LISTEN, SOCKET_STATE_LISTENER, } from "./worker-sockets.js";
...
export function socketTcpBindStart(id, localAddress, family) {
    ...
    socket.future = createFuture((async () => {
        ...
        const code = localAddress.tag === "ipv6"
...
export function socketTcpConnectStart(id, remoteAddress, family) {
    ...
    if (isWildcardAddress(remoteAddress) ||
