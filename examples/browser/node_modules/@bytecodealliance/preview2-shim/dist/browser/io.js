...
// Direct class exports needed by jco-transpiled code
export { IoError, InputStream, OutputStream, Pollable };
// Must not shadow global 'Error' at module top level (TDZ issue with class extends).
// Instead the wrapper will re-export IoError as Error.

// poll export with Pollable as a property (jco expects poll.Pollable)
export const poll = Object.assign(pollList, { Pollable, pollList, pollOne });
