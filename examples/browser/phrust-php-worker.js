"use components";
import { environment, exit as exit$1, stderr, stdin, stdout, terminalInput, terminalOutput, terminalStderr, terminalStdin, terminalStdout } from './node_modules/@bytecodealliance/preview2-shim/dist/browser/cli.js';
import { monotonicClock, wallClock } from './node_modules/@bytecodealliance/preview2-shim/dist/browser/clocks.js';
import { preopens, types } from './node_modules/@bytecodealliance/preview2-shim/dist/browser/filesystem.js';
import { error, poll as poll$1, streams } from './shim-wrappers/io.js';
import { insecureSeed as insecureSeed$1, random } from './node_modules/@bytecodealliance/preview2-shim/dist/browser/random.js';
import { instanceNetwork as instanceNetwork$1, ipNameLookup, network, tcp, tcpCreateSocket, udp, udpCreateSocket } from './shim-wrappers/sockets.js';
const { getArguments,
