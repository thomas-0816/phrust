...
pub mod api {
    pub use crate::builtins::{
        ...
        native_parse_intval_string_base, native_round_f64, php_float_export_string,
    };
    ...
    pub use crate::builtins::{
        ...
        IconvEncodingState, ImageInfo, ImapConnectionConfig, ImapMailboxSnapshot, ImapState,
        InternalFunction, JSON_ERROR_RECURSION, JSON_PARTIAL_OUTPUT_ON_ERROR, JSON_THROW_ON_ERROR,
        JsonRequestState, LdapSearchScope, LdapState, MbSubstituteCharacter,
        NATIVE_HTML_ESCAPE_DEFAULT_FLAGS, NATIVE_JSON_DIRECT_ENCODE_FLAGS,
        NATIVE_JSON_FORCE_OBJECT, NATIVE_JSON_HEX_AMP, NATIVE_JSON_HEX_APOS, NATIVE_JSON_HEX_QUOT,
        NATIVE_JSON_HEX_TAG, NATIVE_JSON_INVALID_UTF8_IGNORE, NATIVE_JSON_INVALID_UTF8_SUBSTITUTE,
        ...
        NativeFilterResult, NativeFilterValue, NativeGlobPublished, NativeIconvConversion,
        NativeInputKey, NativeInputSegment, NativeMoveUploadedFileResult, NativeNetworkAddress,
        NativePackArgument, NativePregCallbackPlanResult, NativePregCapturePublisher,
        NativePregPublishedMatch, NativePregPublishedMatchAll, NativePregReplaceResult,
        NativePrintfScalar, NativeStatRecord, NativeStructuredValuePublisher, NativeUnpackKey,
        NativeUnpackValue, NativeZlibDecodePlan, OpcacheState, OpenSslErrorState, PcntlState,
        ...
        SysvSemaphoreState, SysvSharedMemoryState, ZLIB_ENCODING_DEFLATE, ZLIB_ENCODING_GZIP,
        ZLIB_ENCODING_RAW, append_json_default_string, append_json_string_with_flags,
        build_native_cookie_header_value, build_soap_envelope, decode_native_json_associative_into,
        decode_native_json_into, exact_json_decode, exact_json_encode, exact_json_last_error,
        exact_json_last_error_msg, exact_json_validate, exact_preg_filter, exact_preg_grep,
        exact_preg_last_error, exact_preg_last_error_msg, exact_preg_match, exact_preg_match_all,
        exact_preg_quote, exact_preg_replace, exact_preg_split, exact_printf, exact_sprintf,
        exact_vprintf, exact_vsprintf, hash_algorithm_exists, igbinary_serialize_value,
        igbinary_unserialize_value, is_normalized_string, load_wsdl, msgpack_pack_value,
        msgpack_unpack_value, native_addcslashes_into, native_addcslashes_output_length,
        native_base64_decode_into, native_base64_decode_output_length, native_base64_encode_into,
        ...
        native_filegroup, native_fileinfo_detect_buffer, native_fileinfo_detect_file,
        native_filemtime, native_fileowner, native_fileperms, native_filesize, native_filetype,
        native_filter_id, native_filter_input_source_index, native_filter_names,
        ...
        native_html_escape_output_length, native_html_translation_entries, native_iconv_convert,
        native_image_app_info, native_image_size, native_image_type,
        native_image_type_to_mime_type, native_inet_ntop, native_inet_pton, native_ip2long,
        ...
        native_move_uploaded_file, native_natural_compare, native_number_format,
        native_parse_str_into, native_parse_url_into, native_pathinfo_into, native_phpinfo_output,
        native_preg_callback_plan_into, native_preg_grep_into, native_preg_match_all_into,
        native_preg_match_into, native_preg_replace_many_into, native_preg_replace_scalar,
        native_preg_split_into, native_quoted_printable_decode_into,
        ...
        native_sodium_bin2base64, native_sodium_crypto_generichash, native_stat,
        native_str_pad_into, native_str_pad_output_length, native_stream_is_local,
        ...
        native_uniqid, native_unlink, native_unpack_hex_into, native_url_decode_into,
    ...
    pub use crate::convert::{
        ...
        identical, identical_php, native_bytes_to_number, native_bytes_to_weak_int_parameter,
        php_float_to_int, reset_float_string_precision, set_float_string_precision,
    ...
    pub use crate::db::mysql::{
        ...
        MysqlQueryResult, MysqlRow, MysqlState, native_mysql_escape_string,
    };
    #[cfg(feature = "full-runtime")]
