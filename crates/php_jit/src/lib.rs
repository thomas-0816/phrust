...
pub use abi::{
    ...
    JIT_NATIVE_DIRECT_FIBER_ABI_VERSION, JIT_NATIVE_DIRECT_STRING_BYTE_CAPACITY,
    ...
    JIT_NATIVE_VALUE_VIEW_DIRECT_FOREACH, JIT_NATIVE_VALUE_VIEW_DIRECT_OBJECT,
    JIT_NATIVE_VALUE_VIEW_DIRECT_REFERENCE_SCALAR, JIT_NATIVE_VALUE_VIEW_FLOAT,
    JIT_NATIVE_VALUE_VIEW_FOREACH_DIRECT, JIT_NATIVE_VALUE_VIEW_MATERIALIZED_FIBER,
