...
pub use abi::{
    ...
    JIT_NATIVE_DIRECT_VALUE_INDEX_BASE, JIT_NATIVE_FIBER_SUSPENSION_CAPACITY,
    ...
    JIT_NATIVE_REFERENCE_SCALAR_VIEW_PUBLISHED, JIT_NATIVE_REQUEST_LOCAL_EMPTY,
    JIT_NATIVE_REQUEST_LOCAL_PUBLISHED, JIT_NATIVE_SHARED_ARRAY_ABI_VERSION,
    ...
    JIT_NATIVE_VALUE_VIEW_DIRECT_RESOURCE, JIT_NATIVE_VALUE_VIEW_FLOAT,
    JIT_NATIVE_VALUE_VIEW_FOREACH_DIRECT, JIT_NATIVE_VALUE_VIEW_GLOBALS_PROXY,
    JIT_NATIVE_VALUE_VIEW_MATERIALIZED_FIBER, JIT_NATIVE_VALUE_VIEW_MATERIALIZED_GENERATOR,
    JIT_NATIVE_VALUE_VIEW_NONE, JIT_NATIVE_VALUE_VIEW_PREPARED_CALLABLE,
    ...
    JitNativeDestructorPoint, JitNativeDirectArrayEntry, JitNativeDirectArrayState,
    JitNativeDispatchTrampoline, JitNativeDynamicCodeKind, JitNativeDynamicCodeRequest,
    JitNativeDynamicCodeTrampoline, JitNativeExceptionHandler, JitNativeFastStateHeader,
    ...
    JitNativeInstanceOfPlan, JitNativePcMetadata, JitNativePreparedClassPlan,
    ...
    JitNativeTrustedConstantSlot, JitNativeTrustedGlobalReferenceSlot,
