...
pub use abi::{
    ...
    JitNativeRequestLocalSlot, JitNativeRuntimeViewGuard, JitNativeStaticPropertySlot, JitNativeSuspendKind,
    JitNativeSuspensionGenerationPolicy, JitNativeTransitionState, JitNativeTrustedConstantSlot,
    JitNativeTrustedGlobalReferenceSlot, JitNativeTrustedPropertySlot,
