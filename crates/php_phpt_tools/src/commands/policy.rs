...
pub(super) const EXTENSION_POLICY: &[ExtensionPolicySpec] = &[
    ExtensionPolicySpec {
        ...
        implementation_class: "partial-implementation",
    ...
    ExtensionPolicySpec {
        ...
        needs_stub: true,
        needs_implementation: false,
        implementation_class: "disabled-partial",
        fixture_or_phpt_example: "ext/intl/tests/collator_create.phpt",
        planned_solution_layer: "future intl/ICU extension layer",
        next_action: "Extension reports as not loaded (skipif parity with a reference build lacking intl); grapheme/normalizer/transliterator functions still dispatch. Full intl needs the class surface (Collator, formatters).",
    },
    ExtensionPolicySpec {
        extension: "mbstring",
