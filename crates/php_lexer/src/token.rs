...
/// First named tokenizer ID in the pinned PHP 8.5.7 ABI.
pub const TOKENIZER_TOKEN_ID_BASE: i64 = 260;

/// Token names in their exact PHP 8.5.7 numeric-ID order.
///
/// The index is PHP-visible: `TOKENIZER_TOKEN_ID_BASE + index` must equal the
/// corresponding `T_*` constant exposed by the tokenizer extension.
pub const TOKENIZER_TOKEN_NAMES: &[TokenName] = &[
    TokenName::LNumber,
    TokenName::DNumber,
    TokenName::String,
    ...
    TokenName::Variable,
    TokenName::InlineHtml,
    TokenName::EncapsedAndWhitespace,
    TokenName::ConstantEncapsedString,
    TokenName::StringVarName,
    TokenName::NumString,
    TokenName::Include,
    ...
    TokenName::LogicalOr,
    TokenName::LogicalXor,
    TokenName::LogicalAnd,
    TokenName::Print,
    TokenName::Yield,
    TokenName::YieldFrom,
    ...
    TokenName::Protected,
    TokenName::Public,
    TokenName::PrivateSet,
    TokenName::ProtectedSet,
    TokenName::PublicSet,
    TokenName::Readonly,
    TokenName::Var,
    TokenName::Unset,
    ...
    TokenName::Comment,
    TokenName::DocComment,
    TokenName::OpenTag,
    TokenName::OpenTagWithEcho,
    TokenName::CloseTag,
    TokenName::Whitespace,
    TokenName::StartHeredoc,
    TokenName::EndHeredoc,
    TokenName::DollarOpenCurlyBraces,
    TokenName::CurlyOpen,
