...
/// stable request-local IDs from this versioned table and compares reference
/// behavior by token names, text, lines, and positions.
pub const TOKENIZER_TOKEN_ID_BASE: i64 = 256;

/// Versioned local tokenizer table for PHP 8.5.7 token names.
