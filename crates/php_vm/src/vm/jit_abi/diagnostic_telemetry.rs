//! Diagnostic-only native runtime accounting and report extraction.
//!
//! Production exact handlers contain no telemetry branches. This module may
//! inspect the cold coordinator only after diagnostic publication or request
//! completion.
