...
def rows(engine: Path, release_engine: Path, out_root: Path) -> list[Row]:
    return [
        ...
        Row(
            "cli.empty.fast-preset.debug",
            "execute",
            (str(engine), "run", "--engine-preset=fast", "fixtures/bytecode/lower/valid/empty.php"),
            "",
            timings_index=3,
            counters_index=3,
        ),
        Row(
            "cli.echo.fast-preset.debug",
            "execute",
            (str(engine), "run", "--engine-preset=fast", "fixtures/runtime/valid/scalars/echo.php"),
            "scalar echo\n",
            timings_index=3,
            counters_index=3,
        ),
        Row(
            "cli.echo.fast-preset.release.optional",
            "execute",
            (str(release_engine), "run", "--engine-preset=fast", "fixtures/runtime/valid/scalars/echo.php"),
            "scalar echo\n",
            optional=True,
            timings_index=3,
            counters_index=3,
        ...
        Row(
            ...
            (
                ...
                "--bytecode-cache-dir",
                str(out_root / "bytecode-cache-cold"),
