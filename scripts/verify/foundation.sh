...
required_files=(
  ...
  "Cargo.toml"
  "justfile"
  "docs/foundation/compatibility-target.md"
  "docs/foundation/syntax-sources.md"
  "docs/foundation/runtime-semantics-map.md"
  "docs/foundation/test-matrix.md"
  ...
  "docs/adr/0005-layer-boundaries.md"
...
printf '[pass] foundation verification complete\n'
