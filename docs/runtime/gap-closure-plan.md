...
| `E_PHP_RUNTIME_NUMERIC_STRING_MATRIX` | arrays and array-key conversion | high | high | `fixtures/runtime/valid/scalars/expressions.php`, `fixtures/runtime_semantics/comparisons/array-loose-strict.php`, `fixtures/runtime_semantics/comparisons/elvis-branch-condition-register-reuse.php`, and 32 more |
...
| `E_PHP_RUNTIME_UNSUPPORTED_THROWABLE_HIERARCHY` | Throwable/Error hierarchy and stack traces | high | high | `fixtures/runtime/invalid/exceptions/rethrow.php`, `fixtures/runtime/invalid/exceptions/throw-uncaught.php`, `fixtures/runtime_semantics/errors/catch-error-parent.php`, and 8 more |
