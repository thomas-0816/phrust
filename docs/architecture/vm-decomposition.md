...
array/dimension, object lifecycle, property, and call handlers have moved to
focused owners.
...
| `rich_object_dispatch` | dynamic/static construction, constructor routing, cloning, and clone-with handlers | property storage or general method dispatch |
| `rich_property_dispatch` | object/static property fetch, probe, assign, dimension, and unset handlers | property storage implementation or class lookup policy |
