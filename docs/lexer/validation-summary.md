...
See `docs/lexer/known-lexer-differences.md`. No curated fixture differences
...
Lexer introduced lexer/tokenization code only. It does not introduce a parser,
