...
| Strings | `string_concats, concat_prealloc_hits, string_allocations` | 1064 | `tests/fixtures/performance/perf_smoke/stdlib_dispatch.php` (164) | complete_for_current_counter_set |
