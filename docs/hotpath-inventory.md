...
| --- | --- | ---: | --- | --- |
| Dispatch | `instructions_executed` | 1338 | `tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php` (852) | complete_for_current_counter_set |
...
| Properties | `property_accesses, property_fetches` | 32 | `tests/fixtures/performance/perf_smoke/properties.php` (24) | complete_for_current_counter_set |
| Strings | `string_concats, concat_prealloc_hits, string_allocations` | 1287 | `tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php` (231) | complete_for_current_counter_set |
| Output | `output_bytes, output_buffer_appends, output_buffer_batch_writes, output_batched_appends, output_batch_bytes, output_buffer_flushes, output_fast_appends` | 1435 | `tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php` (334) | complete_for_current_counter_set |
...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | Runtime Allocation | 2543 counted event(s) in tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php | runtime value, container, frame/register, and literal-pool allocation pressure | references, COW, destructor order, and request-local lifetime are observable | destructor, reference, COW, frame reuse, and literal interning fixtures | high |
...
| 4 | Strings | 231 counted event(s) in tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php | string concatenation allocation and conversion fast paths | PHP scalar conversion and binary-safe string behavior must stay exact | concat, scalar conversion, encoding-neutral, and error-order fixtures | high |
