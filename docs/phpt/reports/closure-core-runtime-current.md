...
| `objects.classes` | 200 PASS | 191 PASS / 9 FAIL | backlog |
...
serialization hooks, eval declaration merging, autoload/Reflection catch
behavior, catchable runtime class-declaration dependency failures, and remaining
...
- Closeout module dashboard: `closure.core` 33/33 PASS, `zend.basic` 10/10 PASS, `operators.conversions` 5/5 PASS, `arrays.references` 6/6 PASS, `zend.functions` 29/29 PASS, and `objects.classes` remains 191 PASS / 9 non-green against a 200 PASS reference run.
