...
| mysqli | out-of-scope | 442 | 2 | 4 | 429 | 4 | `runtime-unsupported-feature` 258; `runtime-error-or-diagnostic` 179; `needs-triage` 4 | no | no | no | out-of-scope | Keep network database support out of scope unless explicitly accepted. |
